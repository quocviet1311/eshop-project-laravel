...
class PermissionGateAndPolicyCheck
{
    ...
    {
        Gate::define('menu-list', 'App\Policies\ProductPolicy@view');
        Gate::define('menu-add', 'App\Policies\ProductPolicy@create');
        Gate::define('menu-edit', 'App\Policies\ProductPolicy@update');
        Gate::define('menu-delete', 'App\Policies\ProductPolicy@delete');
    }
}
