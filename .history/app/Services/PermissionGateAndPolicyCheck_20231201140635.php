...
class PermissionGateAndPolicyCheck
{
    ...
    {
        Gate::define('user-list', 'App\Policies\RolePolicy@view');
        Gate::define('user-add', 'App\Policies\RolePolicy@create');
        Gate::define('user-edit', 'App\Policies\RolePolicy@update');
        Gate::define('user-delete', 'App\Policies\RolePolicy@delete');
    }
}
