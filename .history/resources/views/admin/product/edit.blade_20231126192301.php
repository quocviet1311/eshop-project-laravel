...
@section('content')
    <div class="content-wrapper">
        ...
        <form action="{{ route('products.update', ['id' => $product]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control tinymce_editor_init" name="content" rows="6">{{ $product->content }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
